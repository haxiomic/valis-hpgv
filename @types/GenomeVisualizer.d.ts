...
export declare class GenomeVisualizer {
    ...
    addTrack(model: TrackModel, animateIn: boolean, highlightLocation: number): Track;
    addTrackFromFilePath(path: string, name?: string, animateIn?: boolean, highlightLocation?: number): Track;
